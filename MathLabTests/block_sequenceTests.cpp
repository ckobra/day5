...
namespace MathLabTests
{
  ...
  public:
    ...
    {
      mathlab::factory factory;
      factory.register_block("addition", [](std::istream& stream) {return new mathlab::addition(stream); });
      mathlab::block_sequence sequence(factory);
    ...
    TEST_METHOD(append_multiple_and_eval)
    {
      mathlab::factory factory;
      factory.register_block("addition", [](std::istream& stream) {return new mathlab::addition(stream); });
      factory.register_block("multiplication", [](std::istream& stream) {return new mathlab::multiplication(stream); });
      mathlab::block_sequence sequence(factory);
      std::istringstream input("addition 100.\nmultiplication 2.\n");
